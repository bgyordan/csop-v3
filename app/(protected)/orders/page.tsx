...
export default async function OrdersPage({
  ...
  const columns = [
    { key: 'number', label: '№', render: (v: unknown) => <span className="font-mono font-medium text-orange-700">{String(v)}</span> },
    ...
    { key: 'title', label: 'Заглавие' },
    {
      ...
      label: 'Файл',
      render: (v: unknown) => v ? (
        <span className="text-xs bg-orange-50 text-orange-700 px-2 py-1 rounded font-medium">PDF/DOCX</span>
